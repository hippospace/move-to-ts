...
export function setup_voting$ (
  ...
  let active_validators, burn_cap, mint_cap, no_voter_stake, proposer_stake, yes_voter_stake;
  Timestamp.set_time_has_started_for_testing$(core_resources, $c);
  initialize$(core_framework, u128("10"), u64("100"), u64("1000"), $c);
  active_validators = Std.Vector.empty$($c, [AtomicTypeTag.Address] as TypeTag[]);
  Std.Vector.push_back$(active_validators, Std.Signer.address_of$(proposer, $c), $c, [AtomicTypeTag.Address] as TypeTag[]);
  Std.Vector.push_back$(active_validators, Std.Signer.address_of$(yes_voter, $c), $c, [AtomicTypeTag.Address] as TypeTag[]);
  Std.Vector.push_back$(active_validators, Std.Signer.address_of$(no_voter, $c), $c, [AtomicTypeTag.Address] as TypeTag[]);
  Stake.create_validator_set$(core_resources, $.copy(active_validators), $c);
  [mint_cap, burn_cap] = TestCoin.initialize$(core_framework, core_resources, $c);
  proposer_stake = Coin.mint$(u64("100"), mint_cap, $c, [new StructTag(new HexString("0x1"), "TestCoin", "TestCoin", [])] as TypeTag[]);
  yes_voter_stake = Coin.mint$(u64("20"), mint_cap, $c, [new StructTag(new HexString("0x1"), "TestCoin", "TestCoin", [])] as TypeTag[]);
  no_voter_stake = Coin.mint$(u64("10"), mint_cap, $c, [new StructTag(new HexString("0x1"), "TestCoin", "TestCoin", [])] as TypeTag[]);
  Stake.create_stake_pool$(proposer, proposer_stake, u64("10000"), $c);
  Stake.create_stake_pool$(yes_voter, yes_voter_stake, u64("10000"), $c);
  Stake.create_stake_pool$(no_voter, no_voter_stake, u64("10000"), $c);
  Coin.destroy_mint_cap$($.copy(mint_cap), $c, [new StructTag(new HexString("0x1"), "TestCoin", "TestCoin", [])] as TypeTag[]);
...
export function test_cannot_double_vote$ (
  ...
  setup_voting$(core_resources, core_framework, proposer, voter_1, voter_2, $c);
  create_proposal$(proposer, Std.Signer.address_of$(proposer, $c), [], $c);
  vote$(voter_1, Std.Signer.address_of$(voter_1, $c), u64("0"), true, $c);
  vote$(voter_1, Std.Signer.address_of$(voter_1, $c), u64("0"), true, $c);
  return;
}
...
export function buildPayload_test_cannot_double_vote (
  ...
  const typeParamStrings = [] as string[];
  return $.buildPayload(
    "0x1::AptosGovernance::test_cannot_double_vote",
    typeParamStrings,
    []
  );
...
export function test_cannot_double_vote_with_different_voter_addresses$ (
  ...
  create_proposal$(proposer, Std.Signer.address_of$(proposer, $c), [], $c);
  vote$(voter_1, Std.Signer.address_of$(voter_1, $c), u64("0"), true, $c);
  Stake.set_delegated_voter$(voter_1, Std.Signer.address_of$(voter_2, $c), $c);
  vote$(voter_2, Std.Signer.address_of$(voter_1, $c), u64("0"), true, $c);
  return;
}
...
export function buildPayload_test_cannot_double_vote_with_different_voter_addresses (
  ...
  const typeParamStrings = [] as string[];
  return $.buildPayload(
    "0x1::AptosGovernance::test_cannot_double_vote_with_different_voter_addresses",
    typeParamStrings,
    []
  );
...
export function test_voting$ (
  ...
  let proposal_state;
  setup_voting$(core_resources, core_framework, proposer, yes_voter, no_voter, $c);
  create_proposal$(proposer, Std.Signer.address_of$(proposer, $c), [], $c);
  vote$(yes_voter, Std.Signer.address_of$(yes_voter, $c), u64("0"), true, $c);
  vote$(no_voter, Std.Signer.address_of$(no_voter, $c), u64("0"), false, $c);
  Timestamp.update_global_time_for_test$(u64("100001000000"), $c);
  proposal_state = Voting.get_proposal_state$(Std.Signer.address_of$(core_framework, $c), u64("0"), $c, [new StructTag(new HexString("0x1"), "GovernanceProposal", "GovernanceProposal", [])] as TypeTag[]);
  if (!$.copy(proposal_state).eq(u64("1"))) {
    throw $.abortCode($.copy(proposal_state));
  }
  return;
}
...
export function buildPayload_test_voting (
  ...
  const typeParamStrings = [] as string[];
  return $.buildPayload(
    "0x1::AptosGovernance::test_voting",
    typeParamStrings,
    []
  );
