...
export function cmp_bcs_bytes$ (
  ...
  i1 = Vector.length$(v1, $c, [AtomicTypeTag.U8] as TypeTag[]);
  i2 = Vector.length$(v2, $c, [AtomicTypeTag.U8] as TypeTag[]);
  ...
  while (true) {
    ...
    if (!(temp$1)) break;
    {
      ...
      elem_cmp = cmp_u8$($.copy(Vector.borrow$(v1, $.copy(i1), $c, [AtomicTypeTag.U8] as TypeTag[])), $.copy(Vector.borrow$(v2, $.copy(i2), $c, [AtomicTypeTag.U8] as TypeTag[])), $c);
